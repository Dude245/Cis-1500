 ...
 * Date Modified: November 20th
 * DESCRIPTION:
 * This program plays the game of Hangman. Users enter a word up to 7 characters
 * and then the user must guess the word
 * KNOWN  BUGS: Weird spacing after 7 characters, set it to the limit
 */
//Function prototype
void drawhang();
void drawnoose();
